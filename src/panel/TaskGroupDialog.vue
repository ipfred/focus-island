...
import { CATEGORY_COLORS, getCategoryColor, type CategoryColorId } from '../composables/useMemos'

const emit = defineEmits<{
  close: []
}>()

const { groups, addGroup, deleteGroup, renameGroup } = useTaskGroups()
...
function startEdit(group: { id: string; name: string }) {
...
function saveEdit() {
  ...
  if (trimmed) {
    renameGroup(editingId.value, trimmed)
  }
...
function saveNewGroup() {
  ...
  if (trimmed) {
    addGroup(trimmed, newGroupColor.value)
  ...
  <div class="dialog-backdrop" @click="onBackdropClick">
    <div class="dialog-container">
      <div class="dialog-header">
        <span class="dialog-title">管理分组</span>
      ...
      <div class="dialog-body">
        <div class="group-list">
          ...
          >
            <span
              ...
              :style="{ backgroundColor: getCategoryColor(group.color).icon }"
            />
        ...
        <div v-if="showAddForm" class="add-group-form">
          <div class="add-form-row">
            <span
              class="group-color-dot-preview"
              :style="{ backgroundColor: getCategoryColor(newGroupColor).icon }"
            />
            <input
              ref="addInputRef"
          ...
          <div class="color-picker-row">
            ...
            <div class="color-options">
              <button
                ...
                :class="{ active: newGroupColor === color.id }"
                :style="{ borderColor: newGroupColor === color.id ? color.icon : 'rgba(255,255,255,0.2)' }"
          ...
          <div class="add-form-actions">
            <button class="form-btn confirm-btn" @click="saveNewGroup"><span>确认</span></button>
            <button class="form-btn cancel-btn" @click="cancelAdd"><span>取消</span></button>
          </div>
        </div>

        <button v-else class="add-group-btn" @click="startAdd">
